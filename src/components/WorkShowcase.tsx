...
const PROJECTS = [
  ...
  },
  {
    ...
    tag: "STUDIO × BRAND",
    desc: "Estrategia de marca y posicionamiento digital. De concepto a ejecución.",
    image: null as string | null,
    color: "#4ECDC4",
    url: null,
    gridClass: "md:col-span-1 md:row-span-1",
    aspect: "aspect-[3/2]",
    visual: {
      gradient: "linear-gradient(135deg, #4ECDC408 0%, transparent 40%), linear-gradient(315deg, #4ECDC410 0%, transparent 40%), linear-gradient(180deg, #0D1214 0%, #0B0B10 100%)",
      letter: "EM",
      letterSize: "clamp(50px, 10vw, 120px)",
      letterPos: "bottom-4 right-6",
      accent: "#4ECDC4",
      decorLine: true,
      number: "04",
    },
  },
  {
    id: "copa",
    name: "Copa Creadores",
    tag: "STUDIO PRO × EVENT",
    desc: "Identidad visual y sistema de marca para evento de fútbol y creadores de contenido.",
    image: null as string | null,
    color: "#FF6B6B",
    url: null,
    ...
    aspect: "aspect-[21/9]",
    visual: {
      gradient: "radial-gradient(ellipse at 10% 50%, #FF6B6B15 0%, transparent 40%), radial-gradient(ellipse at 90% 50%, #FF6B6B10 0%, transparent 40%), linear-gradient(90deg, #14100F 0%, #0D0D14 50%, #14100F 100%)",
      letter: "CC",
