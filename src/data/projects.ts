...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    desc: {
      ...
      de: "Die AI-native Plattform für das Porsche-Ökosystem. 35.000+ Porsche in Echtzeit aus Japan, der EU und den USA aggregiert — damit Händler, Sammler und Käufer informierte Entscheidungen treffen.",
    },
    ...
    caseStudy: {
      ...
      headline: {
        ...
        de: "Eine Plattform, auf der das gesamte Porsche-Ökosystem mit echten Informationen entscheidet.",
      },
      story: {
      ...
      pillars: [
        { label: "Data", detail: { es: "35,000+ Porsches agregados en tiempo real de Japón, UE y EEUU", en: "35,000+ Porsches aggregated in real time from Japan, EU and the US", de: "35.000+ Porsche in Echtzeit aus Japan, EU und den USA aggregiert" } },
        { label: "Product", detail: { es: "UI editorial, user experience diferencial y market intelligence por modelo", en: "Editorial UI, differential user experience and per-model market intelligence", de: "Editorial-UI, differenzierte UX und Market Intelligence pro Modell" } },
        { label: "Monetization", detail: { es: "Reports, packs one-time y suscripción — visión Salon premium", en: "Reports, one-time packs and subscription — premium Salon vision", de: "Reports, One-Time-Packs und Subscription — Premium Salon Vision" } },
        { label: "Go-to-Market", detail: { es: "Contenido editorial de redes generado con AI desde los listings reales", en: "Editorial social content AI-generated from live platform listings", de: "Editorial-Social-Content AI-generiert aus den Live-Listings" } },
      ],
      press: [],
    },
    gallery: [
